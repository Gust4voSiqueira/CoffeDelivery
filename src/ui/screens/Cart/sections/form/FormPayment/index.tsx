    ...
    <CartSelectContainer>
      ...
      <ButtonsPaymentContainer>
        <button
          ...
          className={`${dataForm.payment === 'CREDIT' && 'selectedPayment'} ${
            isError(errors) && 'error'
          }`}
        >
          <CreditCard size={25} className="iconPayment" />
          CARTÃO DE CRÉDITO
        </button>
        ...
        <button
          ...
          className={`${dataForm.payment === 'DEBIT' && 'selectedPayment'} ${
            isError(errors) && 'error'
          }`}
        >
          <Bank size={25} className="iconPayment" />
          CARTÃO DE DÉBITO
        </button>
        ...
        <button
          ...
          className={`${dataForm.payment === 'MONEY' && 'selectedPayment'} ${
            isError(errors) && 'error'
          }`}
        >
          <Money size={25} className="iconPayment" />
          DINHEIRO
        </button>
      </ButtonsPaymentContainer>
    </CartSelectContainer>
