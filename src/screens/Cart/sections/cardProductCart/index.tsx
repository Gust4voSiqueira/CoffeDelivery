...
import { CartCard, ContQuantitie, TotalValueContainer, TrashContainer } from "./styles";
...
export function CardProductCart({ productCart, handleAlterQuantitieCart, handleRemoveCart }: ICardProductCart) {
  return (
    <div>
      {
          <CartCard key={productCart.id}> 
            ...
            <TotalValueContainer>
              <span>R$ {convertMoney(productCart.price * productCart.quantitie)}</span>
            </TotalValueContainer>
