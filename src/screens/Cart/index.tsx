...
const validateFunction = (dataForm: IFormData) => {
  return {
    ...
    'neighborhood': dataForm.neighborhood.length >= 3 && dataForm.neighborhood.length <= 30,
...
export function Cart() {
  const [dataForm, setDataForm] = useState<IFormData>({ cep: "",  road: "", number: "", complement: "", neighborhood: "", city: "", uf: "", payment: 'NOTSELECTED' })
